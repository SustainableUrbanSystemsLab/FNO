...
def load_single_csv(fp):
    ...
    try:
        ...
        # NOTE: U_over_Uref is the raw background wind ratio (NOT multiplied by 2.0 here —
        # that normalisation only applies to the X input tensor built by build_input_tensor_from_gh).
