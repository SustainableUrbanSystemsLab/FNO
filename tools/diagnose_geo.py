...
Usage:
    uv run python tools/diagnose_geo.py --model geo_fno_weights.pth --data test_csv/your_file.csv
    uv run python tools/diagnose_geo.py --model geo_fno_weights.pth --data test_csv/your_file.csv --output geo_diagnostic.png
"""
...
def run_diagnostics(model_path, data_path, output_name="geo_diagnostic.png"):
    print(f"--- Geo-FNO Diagnostic: {os.path.basename(model_path)} ---")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="geo_fno_weights.pth")
    parser.add_argument("--data",  type=str, required=True,
                        help="Path to a test CSV with ground truth mag_U column")
    parser.add_argument("--output", type=str, default="geo_diagnostic.png")
